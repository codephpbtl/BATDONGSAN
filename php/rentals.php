...
$sql = "SELECT rentals.*, users.FullName AS UserName, storageunits.Name AS UnitName
        FROM rentals
        LEFT JOIN users ON rentals.UserID = users.UserID
        LEFT JOIN storageunits ON rentals.UnitID = storageunits.UnitID";
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <a href="/php/add-rentals.php">Thêm Hóa Đơn</a>
                                ...
                                <table>
                                    ...
                                    <?php foreach ($rentalsData as $rental): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $rental['UnitName']; ?></td>
                                            <td><?php echo $rental['StartDate']; ?></td>
                                            <td><?php echo $rental['EndDate']; ?></td>
                                            <td><?php echo $rental['TotalPrice']; ?></td>
